#############################################################################
# Makefile for building: f
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sat Nov 19 00:10:38 2011
# Project:  f.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile f.pro
#############################################################################
...
Makefile: f.pro  /usr/share/qt/mkspecs/linux-g++-64/qmake.conf /usr/share/qt/mkspecs/common/g++.conf \
		/usr/share/qt/mkspecs/common/unix.conf \
		/usr/share/qt/mkspecs/common/linux.conf \
		/usr/share/qt/mkspecs/qconfig.pri \
		/usr/share/qt/mkspecs/modules/qt_phonon.pri \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/f1.0.0 || $(MKDIR) .tmp/f1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/f1.0.0/ && $(COPY_FILE) --parents main.hh .tmp/f1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/f1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/f1.0.0/ && (cd `dirname .tmp/f1.0.0` && $(TAR) f1.0.0.tar f1.0.0 && $(COMPRESS) f1.0.0.tar) && $(MOVE) `dirname .tmp/f1.0.0`/f1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/f1.0.0
...
moc_main.cpp: main.hh
	/usr/bin/moc $(DEFINES) $(INCPATH) main.hh -o moc_main.cpp
